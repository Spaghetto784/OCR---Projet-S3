...
int main(int argc, char *argv[])
{
    ...
    SDL_Surface *contrasted_image = enhance_contrast(original_image, 5, 0);
    ...
    // Apply the rotation
    SDL_Surface *rotated_image = rotate_image(contrasted_image, angle);


    SDL_FreeSurface(contrasted_image); // Free the contrasted image after rotation
